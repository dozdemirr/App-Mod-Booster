...
# =============================================================================
# Step 2: Deploy main Bicep (app service + managed identity + SQL database, no GenAI)
# =============================================================================
echo "Step 2: Deploying main Bicep template..."
az deployment group create \
  --resource-group $RESOURCE_GROUP \
  --name main \
  --template-file infra/main.bicep \
  --parameters location=$LOCATION adminLogin="$ADMIN_LOGIN" adminObjectId="$ADMIN_OBJECT_ID" deployGenAI=false \
  --output json
...
echo ""
echo "   Chat UI is available at: https://$APP_SERVICE_URL/Chat"
echo "   NOTE: Chat will show dummy responses until you run deploy-with-chat.sh"
