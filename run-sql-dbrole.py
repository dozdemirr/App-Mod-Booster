#!/usr/bin/env python3
"""Apply managed identity DB role script."""
import os
import pyodbc
import struct
...
if __name__ == "__main__":
    managed_identity_name = os.getenv("MANAGED_IDENTITY_NAME", "managed-identity-name")
    with open("script.sql", "r", encoding="utf-8") as file:
        script = file.read().replace("MANAGED-IDENTITY-NAME", managed_identity_name)
